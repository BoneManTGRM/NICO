...
- Last published source HEAD before this checkpoint transition: `2ac496ec2385241ff0b595088061c69c192c118f`. This checkpoint is published with the next atomic source commit on the same branch. Resolve the exact containing commit from `git log -1 --format=%H -- NICO-Ship-Checkpoint.md`; authoritative PR head is the continuation authority. Do not interpret the prior HEAD as this candidate.
- Candidate source/test fingerprint (all changed files against baseline except this ledger, sorted path→SHA256 JSON): `5297fecedcdcd548797d7df763697c2d3b305379733927be5ab7ea75806f9e73` (58 files).
