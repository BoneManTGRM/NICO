...
- Last published branch HEAD before this source transition: `23313c440f18bc7af9efbadbe22f0a3f40dcafff`. Resolve the exact containing commit from `git log -1 --format=%H -- NICO-Ship-Checkpoint.md`; authoritative PR head is the continuation authority. Current source/test candidate is the commit containing this D1 source transition; resolve with `git log -1 --format=%H -- nico/source_signal_analysis_v2.py`. The prior accepted full-CI source was3ca4dd95af6a43cc00fd808b7dccead56e4c8c04.
- Current source/test fingerprint (all changed files against baseline except this ledger; sorted path→SHA256, compact JSON): `4c87360d5b9d45957e45a808650fb22535123d6c49a2100256ec04c21a50e213` (64 files). Prior candidate fingerprint646cf7cb710dcc5b20aef08ab065787f23842d5997633a0840df5cd514efdae8 is retained only for its old evidence.
