...
- Last published branch HEAD before this D6 correction: `86e1dc224a13e4fee8c7a9cd25868c38d406e94d`. Resolve the exact containing commit with `git log -1 --format=%H -- NICO-Ship-Checkpoint.md`; authoritative PR head remains the continuation authority. Current source candidate is the commit containing this correction, also `git log -1 --format=%H -- nico/comprehensive_client_delivery_contract_v1.py`.
