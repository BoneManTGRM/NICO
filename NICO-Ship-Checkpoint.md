...
- Last published source HEAD before this checkpoint transition: `3ca4dd95af6a43cc00fd808b7dccead56e4c8c04`. This checkpoint is published with the next atomic source commit on the same branch. Resolve the exact containing commit from `git log -1 --format=%H -- NICO-Ship-Checkpoint.md`; authoritative PR head is the continuation authority. Do not interpret the prior HEAD as this candidate.
