...
# Compatibility contracts remain transitively loaded through terminal_authority_bootstrap.
# The final production bootstrap adds only the bounded Spanish final-report runtime cache after every report/language compatibility installer.
