    ...
    result = finalize_express_result_consistency(
        {
            ...
            "sections": [
                ...
                {"id": "ci_cd", "label": "CI/CD Analysis", "score": 95, "status": "green", "summary": "", "evidence": ["Workflow text includes test, lint, or build commands.", "npm run lint", "npm run build"], "findings": [], "unavailable": []},
