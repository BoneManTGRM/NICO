...
def _repository() -> dict:
    return {
        ...
        "architecture_evidence": {"source_file_count": 120, "test_path_count": 45, "documentation_path_count": 20},
        "activity_evidence": {"commits_returned": 50, "pull_requests_returned": 25},
        "dependency_evidence": {"manifest_paths": ["requirements.txt", "apps/web/package.json"], "lockfile_paths": ["apps/web/package-lock.json"], "dependency_entries": 200},
...
def _scanner(*, static_material: int = 0) -> dict:
    ...
    return {
        ...
        "timed_out_tools": [],
        "unavailable_tools": [],
        "scanner_results": [{"tool": tool, "status": "completed", "verified_for_this_report": True, "current_run": True} for tool in tools],
        "finding_summary": {
            "by_category": {
                "dependency": {"raw": 2, "material": 0, "review_required": 2, "approved_or_nonblocking": 0, "excluded_test_only": 0},
                "static": {"raw": 6, "material": static_material, "review_required": 4, "approved_or_nonblocking": 0, "excluded_test_only": 2},
            }
        },
    }
