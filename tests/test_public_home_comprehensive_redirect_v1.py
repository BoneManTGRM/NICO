...
def test_english_home_redirects_to_canonical_comprehensive_url() -> None:
...
def test_spanish_home_redirects_to_canonical_spanish_comprehensive_url() -> None:
...
def test_both_homes_are_server_components_not_client_redirects() -> None:
    ...
    # No client-side directives or hooks
