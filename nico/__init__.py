...
from nico.final_report_delivery_package import install_final_report_delivery_package
...
# Convert the completed report package from draft terminology to a final report
# that remains blocked only for authorized human review and delivery approval.
install_final_report_delivery_package()
