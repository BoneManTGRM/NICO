...
_ES_PHRASES = {
    ...
    " around cohesive branch groups, preserve behavior with characterization tests, and enforce cyclomatic complexity below 30 on the exact remediation commit.": " en grupos cohesivos de ramas, conservar el comportamiento con pruebas de caracterización y exigir una complejidad ciclomática inferior a 30 en el commit exacto de remediación.",
    ...
    " around cohesive branch groups, preserve behavior with characterization tests, and enforce cyclomatic complexity below 30 for the durable source anchor.": " en grupos cohesivos de ramas, conservar el comportamiento con pruebas de caracterización y exigir una complejidad ciclomática inferior a 30 para el anclaje de código fuente duradero.",
    ...
    "; retain snapshot-based report fixtures and cross-format truth tests; target complexity below 30.": "; conservar fixtures de informe basados en instantáneas y pruebas de coherencia entre formatos; fijar como objetivo una complejidad inferior a 30.",
    ...
    " into typed hooks or services; split independent rendering branches into bounded child components; add characterization and Playwright coverage; then enforce cyclomatic complexity below 30 for the durable source anchor.": " hacia hooks o servicios tipados; separar las ramas de renderizado independientes en componentes hijos acotados; agregar pruebas de caracterización y cobertura de Playwright; después exigir una complejidad ciclomática inferior a 30 para el anclaje de código fuente duradero.",
    ...
    "The exact-SHA rerun no longer reports cyclomatic complexity of 30 or greater at ": "La nueva ejecución sobre el SHA exacto ya no informa complejidad ciclomática igual o superior a 30 en ",
