...
def markdown_report(payload: dict[str, Any]) -> str:
    ...
    lines.append(json.dumps({"maturity_signal": maturity, "client_delivery_verdict": payload.get("client_delivery_verdict") or {}, "reparodynamics": repair_loop, "truthfulness_rules": payload.get("truthfulness_rules") or [], "assessment_quality": payload.get("assessment_quality", "standard")}, indent=2))
