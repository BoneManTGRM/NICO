...
@app.get("/health")
def health():
    return {"status":"ok","system":"NICO","mode":"local","version":"0.2.0"}
...
def report_owner(): return Response(report_text("owner"), media_type="text/markdown")

@app.get("/reports/developer")
def report_developer(): return Response(report_text("developer"), media_type="text/markdown")

@app.get("/reports/reparodynamic")
def report_reparodynamic(): return Response(report_text("reparodynamic"), media_type="text/markdown")

@app.get("/reports/compliance")
def report_compliance(): return Response(report_text("compliance"), media_type="text/markdown")
