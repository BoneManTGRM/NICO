...
DEFAULT_RUNTIME_CONFIG: dict[str, Any] = {
    ...
    "source": "default",
    "site_title": "NICO",
    "hero_eyebrow": "NICO Platform",
    "hero_powered_by": "Powered by Reparodynamics",
    "hero_headline": "NICO",
    "hero_lead": "Repair intelligence for authorized systems. Evidence-bound assessments, scanner workflows, client-ready reports, and approval-gated repair planning.",
