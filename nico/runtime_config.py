...
DEFAULT_RUNTIME_CONFIG: dict[str, Any] = {
    ...
    "site_title": "NICO",
    "hero_eyebrow": "NICO",
    "hero_headline": "Authorized assessment & repair intelligence",
    "hero_lead": "Evidence-bound code, dependency, CI/CD, QA, scanner, report, and repair workflows for authorized systems only.",
