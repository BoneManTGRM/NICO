...
def render_client_html(markdown: str, title: str, *, spanish: bool, lifecycle_badge: str | None = None) -> str:
    blocks: list[str] = []
    list_items: list[str] = []
    ...
    badge = lifecycle_badge if lifecycle_badge is not None else ES_BOUNDARY if spanish else EN_BOUNDARY
