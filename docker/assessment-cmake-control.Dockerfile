# Trusted tools only. The owned test project enters only the runtime tmpfs.
FROM gcc:14.2.0-bookworm@sha256:82549aa8f90ada3236a8be70c74543132a76662ef33f0c3271ed802b81584a82
# Pinned manylinux2014 x86_64 wheel, published by the CMake distribution team.
# https://pypi.org/project/cmake/3.31.6/#files
COPY cmake.whl /opt/cmake.whl
RUN echo '1c8b05df0602365da91ee6a3336fe57525b137706c4ab5675498f662ae1dbcec  /opt/cmake.whl' | sha256sum -c - \
