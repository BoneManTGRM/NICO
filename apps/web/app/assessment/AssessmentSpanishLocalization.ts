const EXACT_SPANISH = new Map<string, string>([
  ["the existing 0-30/31-90/91-180 roadmap framework was drafted from technical priorities and evidence gaps without creating commitments. no requirement mappings were retained. no stakeholder constraints were retained.", "El marco existente de hoja de ruta de 0-30/31-90/91-180 días se redactó a partir de prioridades técnicas y brechas de evidencia, sin crear compromisos. No se conservaron correspondencias de requisitos. No se conservaron restricciones de las partes interesadas."],
  ["the existing 0-30/31-90/91-180 roadmap framework was drafted from technical priorities and evidence gaps without creating commitments. no requirement mappings were retained. retained stakeholder constraints were included.", "El marco existente de hoja de ruta de 0-30/31-90/91-180 días se redactó a partir de prioridades técnicas y brechas de evidencia, sin crear compromisos. No se conservaron correspondencias de requisitos. Se incluyeron las restricciones conservadas de las partes interesadas."],
  ["the existing 0-30/31-90/91-180 roadmap framework was drafted from technical priorities and evidence gaps without creating commitments. retained requirement mappings were included. no stakeholder constraints were retained.", "El marco existente de hoja de ruta de 0-30/31-90/91-180 días se redactó a partir de prioridades técnicas y brechas de evidencia, sin crear compromisos. Se incluyeron las correspondencias de requisitos conservadas. No se conservaron restricciones de las partes interesadas."],
  ["the existing 0-30/31-90/91-180 roadmap framework was drafted from technical priorities and evidence gaps without creating commitments. retained requirement mappings were included. retained stakeholder constraints were included.", "El marco existente de hoja de ruta de 0-30/31-90/91-180 días se redactó a partir de prioridades técnicas y brechas de evidencia, sin crear compromisos. Se incluyeron las correspondencias de requisitos conservadas. Se incluyeron las restricciones conservadas de las partes interesadas."],
