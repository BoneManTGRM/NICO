...
export type Report = Record<string, unknown> & {markdown?: string; html?: string; pdf_base64?: string; pdf_filename?: string; pdf_error?: string; report_id?: string; pdf_sha256?: string; json?: Record<string, unknown>};
