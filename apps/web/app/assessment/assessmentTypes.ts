...
export type Service = "comprehensive";
...
export type Result = Assessment & {service_id?: string; status?: string; run_id?: string; repository?: string; commit_sha?: string; evidence_ledger_id?: string; customer_id?: string; project_id?: string; current_stage?: string | null; progress_percent?: number; progress?: ProgressItem[]; assessment?: Assessment; reports?: Report; record?: {status?: string; current_stage?: string | null; progress_percent?: number; stage_results?: Record<string, Stage>}; repository_snapshot?: {commit_sha?: string}; persistence?: {recorded?: boolean; durable?: boolean; durability_verified?: boolean; adapter?: string}; human_review_required?: boolean};
