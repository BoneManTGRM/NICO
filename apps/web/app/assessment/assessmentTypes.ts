...
export type Report = Record<string, unknown> & {markdown?: string; html?: string; pdf_base64?: string; pdf_filename?: string; pdf_error?: string; report_id?: string; pdf_sha256?: string; json?: unknown};
...
export type Assessment = Record<string, unknown> & {executive_summary?: string; evidence_coverage?: {calculated?: boolean; percent?: number; label?: string}; maturity_signal?: {level?: string; score?: number; presented_score?: number; technical_score?: number; evidence_adjusted_score?: number}; sections?: Section[]; unavailable_data_notes?: string[]};
