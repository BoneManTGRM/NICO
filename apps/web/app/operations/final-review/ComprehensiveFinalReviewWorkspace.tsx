...
const COPY = {
  en: {
    ...
    reviewerRolePlaceholder: "Principal engineer, CTO, security lead, product owner…",
  ...
  "es-MX": {
    ...
    reviewerRolePlaceholder: "Ingeniero principal, CTO, responsable de seguridad o producto…",
    ...
    <section className={styles.panel}>
      ...
      <form className={styles.form} onSubmit={loadStatus}>
        ...
        <details className={styles.advanced}><summary>{copy.exactIdentity}</summary><div className={styles.advancedGrid}>
          ...
          <label>{copy.exactRunId}<input value={runId} onChange={(event) => {setRunId(event.target.value); setResult(null); setConfirmed(false);}} placeholder="comprun_…" autoCapitalize="none" autoCorrect="off" spellCheck={false} /></label>
        </div></details>
      </form>
