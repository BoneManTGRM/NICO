...
type FullRunResult = {
  ...
  assessment?: {status?: string; maturity_signal?: {level?: string; score?: number; summary?: string}; client_delivery_verdict?: {status?: string; confidence?: string}; sections?: Array<{id?: string; label?: string; score?: number; status?: string; summary?: string}>};
  reports?: {markdown?: string; html?: string; pdf_base64?: string; pdf_filename?: string; pdf_error?: string; report_id?: string};
