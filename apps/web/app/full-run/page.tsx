...
type FullRunResult = {
  ...
  approval?: {approval_id?: string; status?: string; requested_action?: string; run_id?: string; report_id?: string; approver?: string; review_validation?: ReviewValidation; review_decision?: {state?: string; actor?: string; note?: string; decided_at?: string; client_delivery_allowed?: boolean}};
  human_review_required?: boolean;
  client_ready?: boolean;
};
type ReviewTransitionResponse = {status?: string; error?: string; approval?: FullRunResult["approval"]; review_validation?: ReviewValidation};
...
export default function FullRunPage() {
  ...
  async function submitReviewDecision(state: "approved" | "needs_more_evidence" | "rejected") {
    ...
    try {
      ...
      setResult((current) => current ? {...current, approval: data.approval || current.approval} : current);
      setReviewNote("");
  ...
  function downloadDraftPdf() {
    ...
    try {
      ...
      setError("The Full Assessment PDF could not be decoded for download.");
    }
  }
