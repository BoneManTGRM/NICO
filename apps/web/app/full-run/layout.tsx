  ...
  return <>
    ...
    <div className="shell">
      <section className="section panel">
        ...
        <p className="warning-box">Use the exact Full Assessment run ID or report ID and matching customer/project scope. The admin token remains in this browser state only and is never included in ledger or package exports.</p>
